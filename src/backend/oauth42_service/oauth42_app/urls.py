...
from .views import oauth_42_authorization, oauth_42_redirect, oauth_42_access_resource, oauth_42_update_username, get_42_image_view, IsLoggedWith42
...
urlpatterns = [
    ...
    path('is_auth/', IsLoggedWith42.IsLoggedWith42.as_view(), name='is_auth'),
]
