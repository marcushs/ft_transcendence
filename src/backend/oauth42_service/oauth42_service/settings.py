...
ALLOWED_HOSTS = ['localhost', env('SERVER_IP'), 'oauth42']
...
ROOT_URLCONF = 'oauth42_service.urls'
...
WSGI_APPLICATION = 'oauth42_service.wsgi.application'
...
AUTH_USER_MODEL = "oauth42_app.User"
