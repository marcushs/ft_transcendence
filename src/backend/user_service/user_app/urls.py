...
urlpatterns = [
    ...
    path('user_info/', views.get_information_view.as_view(), name='user_info'),
    ...
    path('get_user_by_id/', user_utils.getUserInfoById.as_view(), name='get_user'),
    ...
    path('get_user_status/', user_utils.getUserStatus.as_view(), name='get_user_status'),
    path('get_username/', user_utils.getClientUsername.as_view(), name='get_username'),
