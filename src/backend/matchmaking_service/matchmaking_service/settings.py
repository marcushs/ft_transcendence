...
SECRET_KEY = os.environ.get("MATCHMAKING_SECRET_KEY")
...
MIDDLEWARE = [
    ...
    'matchmaking_app.middleware.JWTAuthMiddleware', # Custom middleware for jwt token feature
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('MATCHMAKING_DB_NAME'),
        'USER': os.environ.get('MATCHMAKING_DB_USER'),
        'PASSWORD': os.environ.get('MATCHMAKING_DB_PASSWORD'),
        'HOST': os.environ.get('MATCHMAKING_DB_HOST'),
        'PORT': os.environ.get('MATCHMAKING_DB_PORT'),
    }
}


AUTH_USER_MODEL = "matchmaking_app.User"
