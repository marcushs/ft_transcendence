...
SECRET_KEY = env("OAUTH_SECRET_KEY")
...
ALLOWED_HOSTS = ['localhost', 'transcendence', '127.0.0.1', 'oauth']
...
MIDDLEWARE = [
    ...
    # 'oauth_app.middleware.JWTAuthMiddleware', # Custom middleware for jwt token feature
...
DATABASES = {
    'default': {
        ...
        'NAME': env('OAUTH_DB_NAME'),
        'USER': env('OAUTH_DB_USER'),
        'PASSWORD': env('OAUTH_DB_PASSWORD'),
        'HOST': env('OAUTH_DB_HOST'),
