...
urlpatterns = [
    ...
    path('get_image/',get_42_image_view.get42ImageViewView.as_view(), name='get_image'),
    path('is_logged_with_42/',is_logged_with_42.get42ImageViewView.as_view(), name='is_logged_with_42'),
]
