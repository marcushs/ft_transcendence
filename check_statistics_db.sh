...
docker exec -e PGPASSWORD=qmg2H79VUGR2nyx statistics psql -U acarlott -d statistics_db -h statistics_db -c "SELECT * FROM statistics_app_matchhistory;" >> statistics_models.txt
